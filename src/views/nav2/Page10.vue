<template>
	<section>
		...
		<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange"  height="360" style="width: 140%;">
			...
			<el-table-column prop="name" label="优秀人才名称" width="180" sortable>
			</el-table-column>
		...
		<el-dialog title="修改" v-model="editFormVisible" :close-on-click-modal="false">
			<el-form :model="editForm" label-width="150px" :rules="editFormRules" ref="editForm">
				<el-form-item label="优秀人才名称" prop="name">
				...
				<el-form-item label="类别">
					<el-select v-model="editForm.category" placeholder="请选择">
						<el-option label="长江学者(国家杰青)" value="长江学者(国家杰青)"></el-option>						
						<el-option label="龙江学者" value="龙江学者"></el-option>						
						<el-option label="教育部新世纪优秀人才支持计划" value="教育部新世纪优秀人才支持计划"></el-option>						
						<el-option label="国家青年科技奖" value="国家青年科技奖"></el-option>						
						<el-option label="省部级青年科技奖" value="省部级青年科技奖"></el-option>										
					</el-select>
				</el-form-item>		
