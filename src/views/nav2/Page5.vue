<template>
	<section>
		...
		<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange"  height="360" style="width: 140%;">
			...
			<el-table-column prop="name" label="成果及知识产权名称" width="180" sortable>
			</el-table-column>
		...
		<el-dialog title="修改" v-model="editFormVisible" :close-on-click-modal="false">
			<el-form :model="editForm" label-width="150px" :rules="editFormRules" ref="editForm">
				<el-form-item label="成果及知识产权名称" prop="name">
				...
				<el-form-item label="证书编号" prop="cNum">
					<el-input v-model="editForm.cNum" auto-complete="off"></el-input>
				</el-form-item>
				...
				<el-form-item label="类别">
					<el-select v-model="editForm.category" placeholder="请选择">
						<el-option label="国家自然科学技术发明一等奖" value="国家自然科学技术发明一等奖"></el-option>						
						<el-option label="国家自然科学技术发明二等奖" value="国家自然科学技术发明二等奖"></el-option>						
						<el-option label="国家科技进步奖一等奖" value="国家科技进步奖一等奖"></el-option>						
						<el-option label="国家科技进步奖二等奖" value="国家科技进步奖二等奖"></el-option>						
						<el-option label="省部级自然科学.技术发明和科技进步奖一等奖" value="省部级自然科学.技术发明和科技进步奖一等奖"></el-option>						
						<el-option label="省部级自然科学.技术发明和科技进步奖二等奖" value="省部级自然科学.技术发明和科技进步奖二等奖"></el-option>						
						<el-option label="省部级自然科学.技术发明和科技进步奖三等奖" value="省部级自然科学.技术发明和科技进步奖三等奖"></el-option>						
						<el-option label="科技成果鉴定(省部级)" value="科技成果鉴定(省部级)"></el-option>						
						<el-option label="国外发明专利授权" value="国外发明专利授权"></el-option>						
						<el-option label="国内发明专利授权" value="国内发明专利授权"></el-option>						
						<el-option label="实用新型专利授权" value="实用新型专利授权"></el-option>						
						<el-option label="软件登记" value="软件登记"></el-option>						
						<el-option label="国家科技部认定社会力量奖" value="国家科技部认定社会力量奖"></el-option>						
						<el-option label="省部级科学技术三等奖" value="省部级科学技术三等奖"></el-option>						
						<el-option label="哈尔滨市政府科学技术一等奖" value="哈尔滨市政府科学技术一等奖"></el-option>						
						<el-option label="哈尔滨市政府科学技术二等奖" value="哈尔滨市政府科学技术二等奖"></el-option>						
						<el-option label="省部级及行业青年科技奖" value="省部级及行业青年科技奖"></el-option>						
						<el-option label="省部级论文成果一等奖" value="省部级论文成果一等奖"></el-option>						
						<el-option label="省部级论文成果二等奖" value="省部级论文成果二等奖"></el-option>						
						<el-option label="哈尔滨市论文成果一等奖" value="哈尔滨市论文成果一等奖"></el-option>						
					</el-select>
				</el-form-item>		
