<template>
	<section>
		...
		<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange"  height="360" style="width: 140%;">
			...
			<el-table-column prop="name" label="教学团队名称" width="180" sortable>
			</el-table-column>
		...
		<el-dialog title="修改" v-model="editFormVisible" :close-on-click-modal="false">
			<el-form :model="editForm" label-width="150px" :rules="editFormRules" ref="editForm">
				<el-form-item label="教学团队名称" prop="name">
				...
				<el-form-item label="类别">
					<el-select v-model="editForm.category" placeholder="请选择">
						<el-option label="国家级教学团队" value="国家级教学团队"></el-option>						
						<el-option label="省级教学团队" value="省级教学团队"></el-option>						
						<el-option label="校级教学团队" value="校级教学团队"></el-option>						
						<el-option label="国际级优秀博士论文指导教师团队" value="国际级优秀博士论文指导教师团队"></el-option>						
						<el-option label="省级优秀博士(硕士)论文指导教师团队" value="省级优秀博士(硕士)论文指导教师团队"></el-option>						
						<el-option label="校级教学成果奖" value="校级教学成果奖"></el-option>						
						<el-option label="校级青年教师授课大赛一等奖" value="校级青年教师授课大赛一等奖"></el-option>						
						<el-option label="校级青年教师授课大赛二等奖" value="校级青年教师授课大赛二等奖"></el-option>						
						<el-option label="国家级优秀博士论文提名" value="国家级优秀博士论文提名"></el-option>						
						<el-option label="省级优秀博士论文" value="省级优秀博士论文"></el-option>						
						<el-option label="省级优秀硕士论文" value="省级优秀硕士论文"></el-option>						
						<el-option label="校级优秀博士论文" value="校级优秀博士论文"></el-option>						
						<el-option label="校级优秀硕士论文" value="校级优秀硕士论文"></el-option>						
						<el-option label="校级优秀本科论文" value="校级优秀本科论文"></el-option>						
					</el-select>
				</el-form-item>		
