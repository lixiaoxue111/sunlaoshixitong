<template>
	<section>
		...
		<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange"  height="360" style="width: 140%;">
			...
			<el-table-column prop="name" label="教研成果名称" width="180" sortable>
			</el-table-column>
			...
			<el-table-column prop="cNum" label="证书号" width="140" sortable>
			</el-table-column>
		...
		<el-dialog title="修改" v-model="editFormVisible" :close-on-click-modal="false">
			<el-form :model="editForm" label-width="150px" :rules="editFormRules" ref="editForm">
				<el-form-item label="教研成果名称" prop="name">
				...
				<el-form-item label="证书号" prop="cNum">
					<el-input v-model="editForm.cNum" auto-complete="off"></el-input>
				</el-form-item>
				<el-form-item label="类别">
					<el-select v-model="editForm.category" placeholder="请选择">
						<el-option label="国家特等奖" value="国家特等奖"></el-option>						
						<el-option label="国家一等奖" value="国家一等奖"></el-option>						
						<el-option label="国家二等奖" value="国家二等奖"></el-option>						
						<el-option label="省部级一等奖" value="省部级一等奖"></el-option>						
						<el-option label="省部级二等奖" value="省部级二等奖"></el-option>						
						<el-option label="省部级优秀奖" value="省部级优秀奖"></el-option>						
						<el-option label="国家精品教材及精品课程" value="国家精品教材及精品课程"></el-option>						
						<el-option label="省部级精品教材及精品课程" value="省部级精品教材及精品课程"></el-option>						
						<el-option label="国家级教学名师" value="国家级教学名师"></el-option>						
						<el-option label="省部级教学名师" value="省部级教学名师"></el-option>						
					</el-select>
				</el-form-item>		
